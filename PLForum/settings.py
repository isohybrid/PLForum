# Django settings for PLForum project.
import os
import lbforum
...
SETTINGS = 'settings'  #v2ex_settings

ADMINS = (
    ('Hybrid', 'ddllsuma@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'PLForum4',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'qq',                  # Not used with sqlite3.
...
SECRET_KEY = '_xnt)zx0@4$#v+re7u+@0v48f2zk^wftz3=9@gw+mi^%ph19k*'
...
ROOT_URLCONF = 'PLForum.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'PLForum.wsgi.application'
...
#change pwd
CHANGE_PSWD_URL = '%saccounts/password/change/' % ROOT_URL

CTX_CONFIG = {
        'LBFORUM_TITLE': 'PLForum',
        'LBFORUM_SUB_TITLE': 'A forum written for PILI lovers',
        'FORUM_PAGE_SIZE': 50,
        'TOPIC_PAGE_SIZE': 20,
